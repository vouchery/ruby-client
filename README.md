...
If the Ruby gem is hosted at a git repository: https://github.com/vouchery/ruby-client, then add the following in the Gemfile:

    gem 'vouchery_client', :git => 'https://github.com/vouchery/ruby-client.git'
