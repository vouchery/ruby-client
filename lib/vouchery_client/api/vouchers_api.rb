...
module Vouchery
  class VouchersApi
    ...
    def batch_generate_vouchers_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/campaigns/{id}/vouchers/batch'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'batch']) 
    ...
    # @option opts [InlineObject4] :inline_object4 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def expire_vouchers_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [Array<String>] :purpose 
    # @option opts [Array<String>] :team 
    # @option opts [Array<String>] :channel 
    ...
    def find_voucher_with_http_info(opts = {})
      ...
      query_params[:'purpose'] = @api_client.build_collection_param(opts[:'purpose'], :multi) if !opts[:'purpose'].nil?
      query_params[:'team'] = @api_client.build_collection_param(opts[:'team'], :multi) if !opts[:'team'].nil?
      query_params[:'channel'] = @api_client.build_collection_param(opts[:'channel'], :multi) if !opts[:'channel'].nil?
