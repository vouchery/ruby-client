...
module Vouchery
  class RedemptionsApi
    ...
    # @param transaction_id ID which identifies the transaction in customer system, e.g. order number, invoice number
    # @param [Hash] opts the optional parameters
    # @return [Array<(Redemption, Fixnum, Hash)>] Redemption data, response status code and response headers
    def confirm_redemption_with_http_info(code, transaction_id, opts = {})
      ...
      # resource path
      local_var_path = '/vouchers/{code}/redemptions'.sub('{' + 'code' + '}', code.to_s)
    ...
    def create_redemption_with_http_info(code, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'redemption'])
      auth_names = ['Basic']
    ...
    def get_redemptions_with_http_info(campaign_id, opts = {})
      ...
      # resource path
      local_var_path = '/campaigns/{campaign_id}/redemptions'.sub('{' + 'campaign_id' + '}', campaign_id.to_s)
