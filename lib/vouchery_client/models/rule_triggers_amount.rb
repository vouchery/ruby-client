  ...
  class RuleTriggersAmount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vouchery::RuleTriggersAmount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vouchery::RuleTriggersAmount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["TriggersAmount"])
      return false unless type_validator.valid?(@type)
      return false if @operator.nil?
      operator_validator = EnumAttributeValidator.new('String', ["equals", "is_more", "is_more_or_equal", "is_less", "is_less_or_equal", "between", "division_remainder_equals_zero"])
      return false unless operator_validator.valid?(@operator)
      return false if @value.nil?
      return false if @group_by.nil?
      group_by_validator = EnumAttributeValidator.new('String', ["customer"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["TriggersAmount"])
    ...
    def operator=(operator)
      validator = EnumAttributeValidator.new('String', ["equals", "is_more", "is_more_or_equal", "is_less", "is_less_or_equal", "between", "division_remainder_equals_zero"])
    ...
    def hash
      [type, operator, value, group_by].hash
    end
