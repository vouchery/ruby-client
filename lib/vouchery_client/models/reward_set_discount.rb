  ...
  class RewardSetDiscount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vouchery::RewardSetDiscount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vouchery::RewardSetDiscount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["SetDiscount"])
      return false unless type_validator.valid?(@type)
      return false if @discount_type.nil?
      discount_type_validator = EnumAttributeValidator.new('String', ["numeric", "percentage", "gift_card"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["SetDiscount"])
    ...
    def discount_type=(discount_type)
      validator = EnumAttributeValidator.new('String', ["numeric", "percentage", "gift_card"])
    ...
    def hash
      [type, title, description, discount_type, discount_value].hash
    end
