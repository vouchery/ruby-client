...
module Vouchery
  class CategoryRule
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['CategoryRule'])
      return false unless type_validator.valid?(@type)
      return false if @rule_type.nil?
      rule_type_validator = EnumAttributeValidator.new('String', ['any_of', 'none_of'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['CategoryRule'])
    ...
    def hash
      [type, id, campaign_id, category_id, rule_type, tags, created_at, updated_at].hash
    end
