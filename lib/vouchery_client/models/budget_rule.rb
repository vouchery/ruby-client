...
module Vouchery
  class BudgetRule
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['BudgetRule'])
      return false unless type_validator.valid?(@type)
      return false if @timeframe.nil?
      timeframe_validator = EnumAttributeValidator.new('String', ['year', 'quarter', 'month', 'week', 'sunday_week', 'day', 'hour'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['BudgetRule'])
    ...
    def timeframe=(timeframe)
      validator = EnumAttributeValidator.new('String', ['year', 'quarter', 'month', 'week', 'sunday_week', 'day', 'hour'])
    ...
    def hash
      [type, id, campaign_id, timeframe, budget, created_at, updated_at].hash
    end
