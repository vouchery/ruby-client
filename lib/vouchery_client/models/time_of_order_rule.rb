...
module Vouchery
  class TimeOfOrderRule
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['TimeOfOrderRule'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['TimeOfOrderRule'])
    ...
    def hash
      [type, id, campaign_id, start_time, end_time, day_of_week, time_zone, created_at, updated_at].hash
    end
