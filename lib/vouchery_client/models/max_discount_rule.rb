...
module Vouchery
  class MaxDiscountRule
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['MaxDiscountRule'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['MaxDiscountRule'])
    ...
    def hash
      [type, id, campaign_id, max_discount, created_at, updated_at].hash
    end
