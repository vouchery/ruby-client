...
module Vouchery
  class Campaign
    ...
    def hash
      [type, id, parent_id, status, name, triggers_on, trigger_name, template, description, customer_information, max_total_budget, max_redemptions, minimum_value, max_discount, currency, currency_symbol, team, channel, purpose, budget_code, medium, voucher_type, voucher_code_type, voucher_random_part_length, voucher_prefix, created_at, updated_at].hash
    end
