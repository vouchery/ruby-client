...
module Vouchery
  class TimeframeRule
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['TimeframeRule'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['TimeframeRule'])
    ...
    def hash
      [type, id, campaign_id, start_time, end_time, time_zone, created_at, updated_at].hash
    end
